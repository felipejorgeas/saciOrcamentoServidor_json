...
/*
$Id: nusoap.php,v 1.1.1.1 2013/08/14 14:27:56 felipe Exp $
...
* @version  $Id: nusoap.php,v 1.1.1.1 2013/08/14 14:27:56 felipe Exp $
* @access   public
*/
class nusoap_base {
	/**
...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=0,$response_timeout=60){
...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=60, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=0, $response_timeout=60, $cookies) {
...
class wsdl extends nusoap_base {
     ...
     * @access public
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=60,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
...
class nusoap_client extends nusoap_base  {
	...
	var $response_timeout = 60;		// HTTP response timeout
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 60, $portName = ''){
		parent::nusoap_base();
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=60) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
